...
#
# path The path to the folder containing the acoustic files you want to rename.
# copy_path If present, path will be the input path and the files will be copied to the copy_path location with the new filename.
# recursive Defaults to True
# input The input file scheme, i.e. the file scheme you want to change. If auto, renameRes will attempt to detect the scheme.
# output The output file scheme. Any value in BAR, BAR_LT, Audiomoth, SM4
# utc_offset The UTC offset if going from any scheme to BAR_LT
# recordingName The name, or prefix if going from Audiomoth to any other file scheme.
